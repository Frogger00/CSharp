// Convierte un nunero entero de entre 1 y 10 a numero romano

int num;

Console.WriteLine("Convierte un nunero entero de entre 1 y 10 a numero romano: \n");
Console.Write("Dame un numero entero ? "); num = int.Parse(Console.ReadLine());
